    ...
    async def _execute_workspace_command(
        ...
        try:
            ...
            if intent == WorkspaceIntent.DRAFT_EMAIL:
                ...
                payload["subject"] = workspace_intent.entities.get("subject", "") or "Draft"
                payload["body"] = context.get("body", "")  # Explicit body from caller
                payload["query"] = command  # Original command for AI body generation
